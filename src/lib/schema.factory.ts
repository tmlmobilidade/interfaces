...
export function createSchemaFactory(collectionName: string) {
	switch (collectionName) {
		...
		case 'files':
			return [CreateFileSchema, UpdateFileSchema];
		case 'hashed_shapes':
